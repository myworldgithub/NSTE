TEMPLATE = app
TARGET = NationalSearchTreasure-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = NationalSearchTreasure-qt_test
...
macx:ICON = src/qt/res/icons/NationalSearchTreasure.icns
macx:TARGET = "NationalSearchTreasure-Qt"
